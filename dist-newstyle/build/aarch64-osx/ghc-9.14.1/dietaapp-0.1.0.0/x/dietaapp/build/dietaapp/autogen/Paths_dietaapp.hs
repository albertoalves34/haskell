...
-- at runtime using the environment variable dietaapp_bindir.
...
-- environment variable dietaapp_libdir.
...
-- using the environment variable dietaapp_dynlibdir.
...
-- runtime using the environment variable dietaapp_datadir.
...
-- using the environment variable dietaapp_sysconfdir.
...
bindir     = "/Users/alberto/.cabal/bin"
libdir     = "/Users/alberto/.cabal/lib/aarch64-osx-ghc-9.14.1-ea4f/dietaapp-0.1.0.0-inplace-dietaapp"
dynlibdir  = "/Users/alberto/.cabal/lib/aarch64-osx-ghc-9.14.1-ea4f"
datadir    = "/Users/alberto/.cabal/share/aarch64-osx-ghc-9.14.1-ea4f/dietaapp-0.1.0.0"
libexecdir = "/Users/alberto/.cabal/libexec/aarch64-osx-ghc-9.14.1-ea4f/dietaapp-0.1.0.0"
sysconfdir = "/Users/alberto/.cabal/etc"

getBinDir     = catchIO (getEnv "dietaapp_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "dietaapp_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "dietaapp_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "dietaapp_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "dietaapp_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "dietaapp_sysconfdir") (\_ -> return sysconfdir)
